...
/**
 * This is the default crash handler that is called in case anything crashes that did not got a special crash handler.
 * Since a call of this crash handler means that its unknown what exactly crashed there is no way in restarting the
 * crashed part. So in this case the BBIWI will be shut down and a error message displayed.
 *
