...
/**
 * This command is used to send a message directly to a player.
 *
 * @author Martin Karing &lt;nitram@illarion.org&gt;
 */
@Immutable
public final class TalkToCmd extends AbstractCommand {
    /**
     * The character id of the character that is supposed to receive the message.
     */
    @Nonnull
    private final CharacterId charId;

    /**
     * The name of the character that is supposed to receive the message.
     * <p/>
    ...
    /**
     * Create a new instance of this talk to command.
     *
     ...
     */
    public TalkToCmd(@Nonnull final CharacterId charId, @Nonnull final String charName, @Nonnull final String message) {
        super(0x05);
        this.charId = charId;
