...
public final class GameScreenController implements GameGui, ScreenController {
    ...
    private final OverviewMapHandler overviewMapHandler;
    ...
    public GameScreenController(final Input input) {
        ...
        overviewMapHandler = new OverviewMapHandler();
    ...
    @Nonnull
    @Override
    public OverviewMapGui getOverviewMapGui() {
